...
JETSON_MODELS        := $(JETSON_CAPTION_MODEL) $(JETSON_PLANNER_MODEL)
...
run-jetson: ## Run ON THE JETSON: build + start the containerised stack, pull its models → http://<jetson>:8000
	@echo "  models     : caption=$(JETSON_CAPTION_MODEL) planner=$(JETSON_PLANNER_MODEL)"; \
